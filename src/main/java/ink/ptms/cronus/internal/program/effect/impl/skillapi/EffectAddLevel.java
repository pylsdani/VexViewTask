 ...
 */
@Auto
public class EffectAddLevel extends Effect {
    ...
    public String pattern() {
        return "skillapi\\.addlevel\\.(?<source>\\S+) (?<count>.+)";
    }

    @Override
    public String getExample() {
        return "skillapi.addlevel.[expsource] [count]";
    }
    ...
    public void eval(Program program) {
        if (program instanceof QuestProgram) {
            ...
            playerData.giveLevels(count, source);
        }
    }

    @Override
    public String toString() {
        return "EffectAddLevel{" +
                "source=" + source +
                ", count=" + count +
                '}';
    }
