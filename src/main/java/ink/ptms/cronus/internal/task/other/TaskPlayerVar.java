 ...
 */
@Task(name = "player_var")
public class TaskPlayerVar extends UnEvent {

    private String key;
    private String value;

    public TaskPlayerVar(ConfigurationSection config) {
        super(config);
    }
