...
import ink.ptms.cronus.internal.task.other.TaskPlayerVar;
 ...
 */
@Auto
public class PlayerVar extends TaskEntry {
    ...
    public ItemStack getItem() {
        return new ItemBuilder(MaterialControl.NAME_TAG.parseMaterial()).name("§f玩家临时变量").lore("", "§7点击选择").flags(ItemFlag.values()).build();
    }

    @Override
    public Class<? extends QuestTask> getTask() {
        return TaskPlayerVar.class;
    }
}
