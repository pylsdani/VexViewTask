 ...
 */
public class ItemTrade2 extends Item {

    public ItemTrade2(Player player, BuilderTaskData builderTaskData) {
    ...
    public org.bukkit.inventory.ItemStack getItem() {
        ...
        return new ItemBuilder(MaterialControl.EMERALD.parseMaterial())
                .name("§7目标物品 (交易位置 2)")
                .lore(
                        "",
