...
import ink.ptms.cronus.builder.task.data.expression.ExpressionDamage;
 ...
 */
@Auto
public class ItemDamage extends TaskEntry {

    public ItemDamage() {
        objective.add(Item.class);
        objective.add(ExpressionTotal.class);
        objective.add(ExpressionDamage.class);
    }
