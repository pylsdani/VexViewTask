 ...
 */
public class LocationFrom extends Location {

    public LocationFrom(Player player, BuilderTaskData builderTaskData) {
    ...
    public ItemStack getItem() {
        if (mode == ink.ptms.cronus.internal.bukkit.Location.Mode.POINT) {
            ...
            return new ItemBuilder(Material.MAP).name("§7目标坐标 (起始地)").lore(lore).build();
        } else {
