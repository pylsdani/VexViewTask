...
import ink.ptms.cronus.internal.task.other.TaskQuestVal;
 ...
 */
@Auto
public class QuestVal extends TaskEntry {
    ...
    public ItemStack getItem() {
        return new ItemBuilder(MaterialControl.NAME_TAG.parseMaterial()).name("§f任务永久变量").lore("", "§7点击选择").flags(ItemFlag.values()).build();
    }

    @Override
    public Class<? extends QuestTask> getTask() {
        return TaskQuestVal.class;
    }
}
